...
public class EPass2003LinuxKeyStoreProvider extends PKCS11KeyStoreProvider {
    ...
    public String getCfg() {
        return is64bit() ? getClass().getResource("/cfg/EPass2003LinuxKeyStoreProvider64Bits.cfg").getPath() : getClass().getResource("/cfg/EPass2003LinuxKeyStoreProvider32Bits.cfg").getPath();
    }
}
