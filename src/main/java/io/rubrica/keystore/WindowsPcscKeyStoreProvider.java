...
public class WindowsPcscKeyStoreProvider extends PKCS11KeyStoreProvider {
    ...
    public String getCfg() {
        return is64bit() ? getClass().getResource("/cfg/WindowsPcscKeyStoreProvider64Bits.cfg").getPath() : getClass().getResource("/cfg/WindowsPcscKeyStoreProvider32Bits.cfg").getPath();
    }
}
